...
Source0  : https://download.kde.org/stable/frameworks/5.82/krunner-5.82.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.82/krunner-5.82.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.82.0
cd %{_builddir}/krunner-5.82.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623276850
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/krunner-5.82.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/krunner-5.82.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/krunner-5.82.0/templates/runner/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Runner.so.5.82.0
