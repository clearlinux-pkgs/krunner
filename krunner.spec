...
Source0  : https://download.kde.org/stable/frameworks/6.2/krunner-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/krunner-6.2.0.tar.xz.sig
...
%setup -q -n krunner-6.2.0
cd %{_builddir}/krunner-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715652372
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Runner.so.6.2.0
/usr/lib64/libKF6Runner.so.6
/usr/lib64/libKF6Runner.so.6.2.0
