...
Source0  : https://download.kde.org/stable/frameworks/5.94/krunner-5.94.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.94/krunner-5.94.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.94.0
cd %{_builddir}/krunner-5.94.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652670748
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/krunner-5.94.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/krunner/ea97eb88ae53ec41e26f8542176ab986d7bc943a
cp %{_builddir}/krunner-5.94.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/krunner/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/krunner-5.94.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/3cb34cfc72e87654683f2894299adf912d14b284
cp %{_builddir}/krunner-5.94.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/krunner-5.94.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/krunner-5.94.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/krunner/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/krunner-5.94.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/krunner/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/krunner-5.94.0/README.md.license %{buildroot}/usr/share/package-licenses/krunner/680295cd7d254d11edba2a4e8afd7810c79925d2
cp %{_builddir}/krunner-5.94.0/src/declarative/qmldir.license %{buildroot}/usr/share/package-licenses/krunner/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/krunner-5.94.0/templates/runner/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/krunner/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Runner.so.5.94.0
