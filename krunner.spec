...
Source0  : https://download.kde.org/stable/frameworks/5.66/krunner-5.66.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.66/krunner-5.66.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.66.0
cd %{_builddir}/krunner-5.66.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578965954
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/krunner-5.66.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/krunner/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Runner.so.5.66.0
