...
Source0  : https://download.kde.org/stable/frameworks/5.115/krunner-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/krunner-5.115.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.115.0
cd %{_builddir}/krunner-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707768608
mkdir -p clr-build
pushd clr-build
