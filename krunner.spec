...
Version  : 5.100.0
Release  : 55
URL      : https://download.kde.org/stable/frameworks/5.100/krunner-5.100.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.100/krunner-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/krunner-5.100.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.100.0
cd %{_builddir}/krunner-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668469999
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Runner.so.5.100.0
