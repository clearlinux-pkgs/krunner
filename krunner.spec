...
Source0  : https://download.kde.org/stable/frameworks/5.107/krunner-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/krunner-5.107.0.tar.xz.sig
...
%prep
%setup -q -n krunner-5.107.0
cd %{_builddir}/krunner-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686597304
mkdir -p clr-build
pushd clr-build
